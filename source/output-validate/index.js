 ...
 * @function OutputValidate
 * @description Get the job Id an assets GUID from the the MediaConvert Job Output, download
 * the Job details and then loop through the outputgroups to determin the S3 and CloudFront
 * URLS for each output.
 *
 *********************************************************************************************/
